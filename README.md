...
```sh
$ pip install git+https://github.com/colinochieng/quart-login.git
```
...
For complete understanding of available configuration, please refer to the [source code](https://github.com/colinochieng/quart-login).
